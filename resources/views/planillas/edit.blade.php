    ...
    <div class="col-lg-12 order-lg-1">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">{{ __('Editar Planilla') }}</h6>
            </div>
            @if(session('estado'))
            ...
            @endif
            <div class="card-body">
            <form method="POST" action="{{route('planillas.update', ['planilla'=>$planilla->id])}}" autocomplete="off" novalidate enctype="multipart/form-data">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="form-group focused">
                            ...
                            <input type="text" class="form-control @error('numero_planilla') is-invalid @enderror" name="numero_planilla" id="numero_planilla" value="{{ $planilla->numero_planilla}}" placeholder="Número de la Planilla">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group focused">
                            ...
                            <select name="id_dependencia" id="id_dependencia" class="form-control @error('id_dependencia') is-invalid @enderror">
                                <option value="$planilla->id_dependencia" selected disabled>{{$planilla->dependencia->nombre}}</option>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group focused">
                            ...
                            <select name="tipo_envio" id="tipo_envio" class="form-control @error('tipo_envio') is-invalid @enderror">
                                <option value="{{$planilla->tipo_envio}}" selected disabled>{{$planilla->tipoenvio->nombre}}</option>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group focused">
                            ...
                            <select name="tipo_planilla" id="tipo_planilla" class="form-control @error('tipo_planilla') is-invalid @enderror">
                                <option value="{{$planilla->tipo_planilla}}" selected disabled>{{$planilla->tipoplanilla->nombre}}</option>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group focused">
                            ...
                            <select name="tipo_destino" id="tipo_destino" class="form-control @error('tipo_destino') is-invalid @enderror">
                                <option value="{{$planilla->tipo_destino}}" selected disabled>{{$planilla->tipodestino->nombre}}</option>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="form-group focused">
                            ...
                            <input type="text" class="form-control @error('autoridad_destino') is-invalid @enderror" name="autoridad_destino" id="autoridad_destino" value="{{$planilla->autoridad_destino}}" placeholder="Autoridad de Destino">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="form-group focused">
                            ...
                            <textarea name="contenido_destino" id="contenido_destino" class="form-control @error('contenido_destino') is-invalid @enderror" placeholder="Contenido Destino" style="min-height: 200px">{{ $planilla->contenido_destino}}</textarea>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4">
                        <div class="form-group focused">
                            ...
                            <input type="text" class="form-control @error('direccion') is-invalid @enderror" name="direccion" id="direccion" value="{{$planilla->direccion}}" placeholder="Dirección">
                            @error('direccion')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group focused">
                            ...
                            <input type="text" class="form-control @error('ciudad') is-invalid @enderror" name="ciudad" id="ciudad" value="{{$planilla->ciudad}}" placeholder="Ciudad">
                            @error('ciudad')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group focused">
                            ...
                            <input type="text" class="form-control @error('departamento') is-invalid @enderror" name="departamento" id="departamento" value="{{$planilla->departamento}}" placeholder="Departamento">
                            @error('departamento')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="form-group focused">
                            ...
                            <input type="text" class="form-control @error('peso') is-invalid @enderror" name="peso" id="peso" value="{{$planilla->peso}}" placeholder="Peso">
                            @error('peso')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group focused">
                            ...
                            <input type="text" class="form-control @error('cantidad') is-invalid @enderror" name="cantidad" id="cantidad" value="{{$planilla->cantidad}}" placeholder="Cantidad">
                            @error('cantidad')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4">
                        <div class="form-group focused">
                            ...
                            <input type="text" class="form-control @error('valor_declarado') is-invalid @enderror" name="valor_declarado" id="valor_declarado" value="{{$planilla->valor_declarado}}" placeholder="Valor Declarado">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group focused">
                            ...
                            <input type="text" class="form-control @error('seguro') is-invalid @enderror" name="seguro" id="seguro" value="{{$planilla->seguro}}" placeholder="Seguro">
                            @error('seguro')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group focused">
                            ...
                            <input type="text" class="form-control @error('valor_total') is-invalid @enderror" name="valor_total" id="valor_total" value="{{$planilla->valor_total}}" placeholder="Valor Total">
                            @error('valor_total')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="form-group focused">
                            ...
                            <select name="usuario_entrega" id="usuario_entrega" class="form-control @error('usuario_entrega') is-invalid @enderror">
                                <option value="{{$planilla->usuario_entrega}}" selected disabled>{{$planilla->entrega->fullname}}</option>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group focused">
                            ...
                            <input class="form-control @error('fecha_entrega') is-invalid @enderror" name="fecha_entrega" type="date" id="fecha_entrega" value="{{$planilla->fecha_entrega}}">
                            @error('fecha_entrega')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="form-group focused">
                            ...
                            <select name="usuario_recibe" id="usuario_recibe" class="form-control @error('usuario_recibe') is-invalid @enderror">
                                <option value="{{$planilla->usuario_recibe}}" selected disabled>{{$planilla->recibe->fullname}}</option>
                                @foreach ($usuarios as $usuario)
                    ...
                    <div class="col-lg-6">
                        <div class="form-group focused">
                            ...
                            <input class="form-control @error('fecha_recibe') is-invalid @enderror" name="fecha_recibe" type="date" id="fecha_recibe" value="{{ $planilla->fecha_recibe}}">
                            @error('fecha_recibe')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
